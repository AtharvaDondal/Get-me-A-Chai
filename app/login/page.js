    ...
    <div className=" py-14 mx-auto containerz">
      ...
      <div className="flex flex-col  items-center gap-2 min-h-screen p-10">
        ...
        <button
          ...
          className="flex items-center border w-64 bg-slate-50 text-black border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
        >
          <svg
            className="h-6 w-6 mr-2"
            xmlns="http://www.w3.org/2000/svg"
